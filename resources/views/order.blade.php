            ...
            <div class="row justify-content-center">
                ...
                <form action="http://internet-shop.tmweb.ru/basket/place" method="POST">
                    <div>
                        ...
                        <br>
                        <input type="hidden" name="_token" value="O3mcXm4Di4whvv6dYh0QZ3nVhIc8HuUYhfYHoldf">                    <input type="submit" class="btn btn-success" value="Подтвердите заказ">
                    </div>
                </form>
            </div>
        </div>
